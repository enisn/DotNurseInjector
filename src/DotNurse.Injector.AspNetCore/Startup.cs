...
namespace Microsoft.Extensions.Hosting
{
    ...
    {
        /// <summary>
        /// Use <see cref="DotNurseServiceProvider"/> instead of default <see cref="IServiceProvider"/>. It makes possible to use [<see cref="DotNurse.Injector.Attributes.InjectServiceAttribute"/>] for properties nad fields instead of constructor injection.
        /// </summary>
